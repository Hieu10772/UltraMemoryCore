...
public enum MemoryProfile {
    ...
    MemoryProfile(int maxPaletteCache, int maxUploadBufferSize, long poolTimeoutMs) {
        this.maxPaletteCache = maxPaletteCache;
        this.maxUploadBufferSize = maxUploadBufferSize;
        this.poolTimeoutMs = poolTimeoutMs;
    }

    public int getMaxPaletteCache() { return maxPaletteCache; }
    public int getMaxUploadBufferSize() { return maxUploadBufferSize; }
